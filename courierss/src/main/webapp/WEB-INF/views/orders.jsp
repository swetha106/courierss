...
String connectionURL = "jdbc:mysql://localhost:3306/courierss";
...
String QueryString = "SELECT * from courierss.orders";
...
<TABLE class="mytab" id="tables">
			...
			<tr class="header">
			    ...
			    <th style="width: 20%">PLACED_DATE</th>
			    <th style="width: 20%">SHIPPED_DATE</th>
			    <th style="width: 20%">DELIVERY_DATE</th>
			  </tr>
			   </thead>
			  <tbody id="geeks">
			<%
