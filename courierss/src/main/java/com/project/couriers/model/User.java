...
public class User {
	...
	public String toString() {
		return "User [userId=" + userId + ", username=" + username + ",password=" + password + ", maildId=" + maildId + ", mobileno=" + mobileno
				+ ", address=" + address + "]";
	}
	...
	public User(Integer userId, String password, String maildId, String mobileno, String address) {
		super();
		this.userId = userId;
		this.password = password;
		this.maildId = maildId;
